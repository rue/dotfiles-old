...
" Regexp matching for """blah""".r This is dumb
" and needs the oneline to have a terminator, but
" it does work. --eeppa
syn region scalaRegexp start="\"\"\"" end="\"\"\".r" oneline contains=scalaRegexpEscape
syn match scalaRegexpEscape "[|()^$[\]\\]" contained
syn match scalaRegexpEscape "\\u[0-9a-fA-F]\{4}" contained
syn match scalaRegexpEscape "\\[aAzZbBdDsS\\\"]" contained
...
hi link scalaRegexpEscape Keyword
